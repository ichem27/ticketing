...
<head>
    ...
    <!-- Bootstrap core CSS -->
    <link rel="stylesheet" href="Contenu/bootstrap.min.css" <!-- Favicons -->
                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            <a class="dropdown-item" href="index.php?action=gestick">tickets</a>
                            <a class="dropdown-item" href="index.php?action=gesetat">états</a>
                        </div>
                    </li>
                </ul>
            </div>
